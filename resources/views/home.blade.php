        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="assets-home/img/caty.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block">Best Pet Services</h3>
                            <h1 class="display-3 text-white mb-3">Love For Paws </h1>
                            <h5 class="text-white mb-3 d-none d-sm-block">A heaven for Pets</h5>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="assets-home/img/dog1.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block">Best Pet Services</h3>
                            <h1 class="display-3 text-white mb-3">Passion For Claws</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block">Wise pet wise store</h5>
                            <a href="" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4">Book Now</a>
                            <a href="" class="btn btn-lg btn-secondary mt-3 mt-md-4 px-4">Learn More</a>
                        </div>
                    </div>
        ...
        <div class="row py-5">
            ...
            <div class="col-lg-5">
                <div class="row px-3">
                    ...
                    <div class="col-6 p-0">
                        <img class="img-fluid w-100" src="assets-home/img/sleepycattt.jpg" alt="">
                    </div>
                    <div class="col-6 p-0">
                        <img class="img-fluid w-100" src="assets-home/img/dog.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team card position-relative overflow-hidden border-0 mb-4">
                    <img class="card-img-top" src="assets-home/img/team-2.jpg" alt="">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team card position-relative overflow-hidden border-0 mb-4">
                    <img class="card-img-top" src="assets-home/img/team-3.jpg" alt="">
                    <div class="card-body text-center p-0">
                        <div class="team-text d-flex flex-column justify-content-center bg-light">
                            <h5>Kate Glover</h5>
                            <i>Doctor</i>
    ...
    <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5" >
            <div class="col-lg-4 col-md-12 mb-5">
                <h1 class="mb-1 display-4 text-capitalize text-white"><span class="text-primary">Pet</span>Lover</h1>
                <div class="col-10 p-0">
                    <img class="img-fluid w-100" src="assets-home/img/petshop.jpg" alt="">
                </div>
            </div>
